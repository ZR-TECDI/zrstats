    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nacionalidad', models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, to='asistencia.Nacionalidad', verbose_name='Nacionalidad')),
                ('rango', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='asistencia.Rango', verbose_name='Rango')),
                ('rol', models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, to='asistencia.Rol', verbose_name='Rol')),
                ('unidad', models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, to='asistencia.Unidad', verbose_name='Unidad')),
            ],
        ),
        migrations.CreateModel(
            name='Asistencia',
            fields=[
                ...
                ('miembro', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='asistencia.Miembro', verbose_name='Miembro')),
                ('mision', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='asistencia.Mision', verbose_name='Mision')),
            ],
            options={

# Generated by Django 2.2.5 on 2019-09-14 15:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clase1', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='clase1', to='stats.Clase', verbose_name='Clase 1')),
                ('clase2', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='clase2', to='stats.Clase', verbose_name='Clase 2')),
                ('nacionalidad', models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, to='stats.Nacionalidad', verbose_name='Nacionalidad')),
                ('rango', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='stats.Rango', verbose_name='Rango')),
                ('rol', models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, to='stats.Rol', verbose_name='Rol')),
                ('unidad', models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, to='stats.Unidad', verbose_name='Unidad')),
            ],
        ),
        migrations.CreateModel(
            name='Asistencia',
